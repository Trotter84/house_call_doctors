    ...
    <>
      ...
      <div className='mainContainer-aboutUs'>
        ...
        <div className='container-aboutUs'>
          ...
          <div className='leftHalf-aboutUs'>

            <h3 className='subTitle-aboutUs'>Where It All Started</h3>
              <div className='subTextContainer-aboutUs'>
                <p className='subText-aboutUs'>
              ...
              <h3 className='subTitle-aboutUs'>Primary Care in the home is our specialty</h3>
              <div className='subTextContainer-aboutUs'>
                <p className='subText-aboutUs'>After hours, weekends, and holidays:<br />(Our providers are always available via pager!)</p>
                <p className='contacts-aboutUs'><b>Mark Cacciamani</b>, MD <b>(801) 241-4483</b></p>
                <p className='contacts-aboutUs'><b>Perrine Anderson</b>, APRN <b>(801) 241-0623</b></p>
                <p className='contacts-aboutUs'><b>Courtney Harper</b>, PA-C <b>(801) 241-0255</b></p>
                <p className='contacts-aboutUs'><b>Gwen Mitchell</b>, APRN <b>(801) 241-0339</b></p>
                <p className='contacts-aboutUs'><b>Edie Shepherd</b>, APRN <b>(801) 241-0021</b></p>
                <p className='contacts-aboutUs'><b>Trenaisa Nay</b>, GNP <b>(801) 241-0484</b></p>
                <p className='subText-aboutUs'>These are numeric pagers, they do not accept voicemail or text messages.</p>
                <p className='subText-aboutUs'>After dialing the pager number, dial your own phone number followed by the pound key.</p>
                <p className='subText-aboutUs'>Please allow 15-30 minutes for a return call, and repeat the process every 30 minutes until your call is returned.</p>
              </div>

              <h3 className='subTitle-aboutUs'>Taking The Next Steps</h3>
              <div className='subTextContainer-aboutUs'>
                <p className='subText-aboutUs'>For appointments, call our office at <b>801-485-5055</b>.<br />We have set aside a special day each month to visit you at your home or the facility where you reside.</p>
                <p className='subText-aboutUs'>If you are interested in becoming a new patient, please contact our office to obtain a copy of our <b>New Patient Registration</b> and return to our office 48 hours prior to your first appointment.<br /><br />This packet will help your doctor gather pertinent health information about you so that he/she can better focus on your issues today.</p>
                <p className='subText-aboutUs'>For fastest results, have your pharmacy fax us your refill requests <b>801-467-3296</b>.<br />Please allow 24-48 business hours for a response.</p>
              </div>
